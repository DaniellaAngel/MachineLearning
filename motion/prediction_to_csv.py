...
# fileinfo2 = open('V2.0motion20_30_len_pred.csv','w')
# fileinfo3 = open('V2.0motion40_30_len_pred.csv','w')
# fileinfo4 = open('V2.0motion60_30_len_pred.csv','w') 

fileinfo1 = open('V2.0resize.csv','w')
fileinfo2 = open('V2.0motion20_15_pred.csv','w')
fileinfo3 = open('V2.0motion20_30_pred.csv','w')
fileinfo4 = open('V2.0motion20_45_pred.csv','w') 
